  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="{{route('himatif.index')}}">Beranda</a></li>
          ...
          <li><a class="nav-link scrollto active" href="{{route('frontpengurus.index')}}">Pengurus HIMATIF</a></li>
          <li><a class="nav-link scrollto active" href="#hero">E-Voting</a></li>
          <li><a class="nav-link scrollto active" href="#hero">Unduhan</a></li>
